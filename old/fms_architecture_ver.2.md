...
| **Mobile Apps** | Flutter | Field personnel app, inspection checklists |
| **Mapping** | OpenStreetMap | GIS mapping, route visualization |
...
| Category | Technology | Purpose |
|---------|------|---------|
| **Application Server** | Node.js (NestJS)  | Mission-critical business logic |
| **Workflow Engine** | Temporal | Complex dispatch workflow automation |
| **API Layer** | RESTful API | Client communication |
...
| **Analytics DB** | Data Warehouse (BigQuery) | BI & reporting |
